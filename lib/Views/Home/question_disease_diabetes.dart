...
import 'package:NutritionApplication/Views/Home/question_disease_cholesterol.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class QuestionDiseaseDiabetes extends StatefulWidget {
  QuestionDiseaseDiabetes({Key? key}) : super(key: key);

  @override
  State<QuestionDiseaseDiabetes> createState() =>
      _QuestionDiseaseDiabetesState();
}

class _QuestionDiseaseDiabetesState extends State<QuestionDiseaseDiabetes> {
  int selectedCard = 0;
                    ...
                    child: Padding(
                        ...
                        child: SizedBox(
                          ...
                          child: TextButton(
                              ...
                              onPressed: () {
                              //  Utils.goal!.diabetes = selectedCard;
                                Routes(context: context)
                                    .navigate(QuestionDiseaseCholesterol());
                              }),
                        )),
                  )
                ],
