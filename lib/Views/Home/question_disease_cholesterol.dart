...
import 'package:NutritionApplication/Views/Home/question_disease_fattyliver.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class QuestionDiseaseCholesterol extends StatefulWidget {
  QuestionDiseaseCholesterol({Key? key}) : super(key: key);

  @override
  State<QuestionDiseaseCholesterol> createState() =>
      _QuestionDiseaseCholesterolState();
}

class _QuestionDiseaseCholesterolState
    extends State<QuestionDiseaseCholesterol> {
  int selectedCard = 0;
  @override
                    ...
                    child: Padding(
                        ...
                        child: SizedBox(
                          ...
                          child: TextButton(
                              ...
                              onPressed: () {
                                // Utils.goal!.cholesterol = selectedCard;
                                Routes(context: context)
                                    .navigate(QuestionDiseaseFattyLiver());
                              }),
                        )),
                  )
                ],
